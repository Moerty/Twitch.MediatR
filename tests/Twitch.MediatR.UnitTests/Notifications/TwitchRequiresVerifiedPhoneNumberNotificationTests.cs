...
public class TwitchRequiresVerifiedPhoneNumberNotificationTests {
    [Test]
    public void PropertyTest() {
        ...
        var notification = new TwitchRequiresVerifiedPhoneNumberNotification(cLink.Object, message, channel);
